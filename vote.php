...
<?php include("./nav.php"); ?>
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="container-fluid" align="center">
                ...
                <div class="col-lg-auto">
                    <div class="card mb-lg-auto" align="center" style="max-width: 20rem;">
                        <h5 class="card-header text-white bg-info"> Vice President</h5>
                        <div class="card-body">
                            <?php
                                if (!$_SESSION["lwf"]) {
                                    echo "<h3 class='card-text alert alert-danger'>NO VOTE</h3>";
                ...
                <div class="col-lg-auto">
                    <div class="card mb-lg-auto" align="center" style="max-width: 20rem;">
                        <h5 class="card-header text-white bg-info">Secratary</h5>
                        <div class="card-body">
                            <?php
                                if (!$_SESSION["rwf"]) {
                                    echo "<h3 class='card-text alert alert-danger'>NO VOTE</h3>";
                ...
                <div class="col-lg-auto">
                    <div class="card mb-lg-auto" align="center" style="max-width: 20rem;">
                        <h5 class="card-header text-white bg-info">Fin. Secratary</h5>
                        <div class="card-body">
                            <?php
                                if (!$_SESSION["amf"]) {
                                    echo "<h3 class='card-text alert alert-danger'>NO VOTE</h3>";;
                ...
                <div class="col-lg-auto">
                    <div class="card mb-lg-auto" align="center" style="max-width: 20rem;">
                        <h5 class="card-header text-white bg-info">Dean</h5>
                        <div class="card-body">
                            <?php
                                if (!$_SESSION["cmf"]) {
                                    echo "<h3 class='card-text alert alert-danger'>NO VOTE</h3>";;
                ...
                <div class="col-lg-auto">
                    <div class="card mb-lg-auto" align="center" style="max-width: 20rem;">
                        <h5 class="card-header text-white bg-info">D.O.S</h5>
                        <div class="card-body">
                            <?php
                                if (!$_SESSION["dmf"]) {
                                    echo "<h3 class='card-text alert alert-danger'>NO VOTE</h3>";;
